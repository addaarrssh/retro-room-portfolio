...
export default function ArcadeApp() {
  ...
  return (
    <div className="h-full w-full overflow-hidden p-6 font-mono text-sm leading-relaxed text-slate-300 flex flex-col items-center justify-between select-none">
