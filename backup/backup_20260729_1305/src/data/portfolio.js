...
export const disks = [
  { id: 'showcase', label: 'Showcase.app', appId: 'showcase', color: '#38bdf8' },
  { id: 'about', label: 'About.app', appId: 'about', color: '#f43f5e' },
  { id: 'projects', label: 'Projects.app', appId: 'projects', color: '#10b981' },
  { id: 'contact', label: 'Contact.app', appId: 'contact', color: '#fbbf24' },
  { id: 'music', label: 'Music.app', appId: 'music', color: '#a855f7' },
  { id: 'arcade', label: 'Arcade.app', appId: 'arcade', color: '#ec4899' },
  { id: 'resume', label: 'Resume.pdf', appId: 'resume', color: '#64748b' },
]
...
/* Music_Player.app tracks — points to local MP3 files in public/audio/ with fallback to Web Audio synth */
export const tracks = [
  // --- 🇮🇳 Popular Indian Songs ---
  {
    ...
    bpm: 88,
    root: 48,
    progression: [[0, 4, 7, 11], [-3, 0, 5, 9], [-7, -3, 0, 5], [-5, -1, 2, 7]],
    lead: [16, 19, 23, 19, 21, 19, 16, 14],
    swing: 0.12,
  },
  {
    id: 'tum-hi-ho',
    ...
    bpm: 72,
    root: 45,
    progression: [[0, 3, 7, 10], [-4, 0, 3, 7], [-7, -3, 0, 5], [-5, -2, 3, 7]],
  ...
  },
  {
    ...
    bpm: 96,
    root: 43,
    progression: [[0, 3, 7, 10], [-3, 0, 4, 7], [3, 7, 10, 14], [-2, 2, 5, 9]],
    lead: [15, 19, 22, 19, 17, 15, 12, 10],
    swing: 0.16,
  },
  {
    id: 'kal-ho-naa-ho',
    title: 'Kal Ho Naa Ho',
    artist: 'Sonu Nigam & SEL',
    category: 'INDIAN',
    audioUrl: '/audio/kal_ho_naa_ho.mp3',
    bpm: 78,
    root: 48,
    progression: [[0, 4, 7, 12], [-1, 4, 7, 11], [-3, 2, 5, 9], [-5, -1, 2, 7]],
    lead: [12, 16, 19, 24, 19, 16, 14, 12],
    swing: 0.1,
  },

  // --- 🇬邦🇺🇸 Popular English Hits ---
  {
    id: 'shape-of-you',
    title: 'Shape of You',
    artist: 'Ed Sheeran',
    ...
    bpm: 96,
    root: 44,
    progression: [[0, 3, 7, 10], [5, 8, 12, 15], [1, 5, 8, 12], [3, 6, 10, 13]],
    lead: [15, 15, 18, 15, 18, 20, 18, 15],
    swing: 0.14,
  },
  {
    id: 'blinding-lights',
    ...
    bpm: 110,
    root: 43,
    progression: [[0, 3, 7, 10], [-5, -2, 3, 7], [-3, 0, 4, 7], [3, 7, 10, 14]],
    lead: [19, 15, 12, 15, 19, 22, 19, 15],
    swing: 0.08,
  },
  {
    id: 'perfect',
    ...
    bpm: 63,
    root: 43,
    progression: [[0, 4, 7, 12], [-4, 0, 3, 7], [-7, -3, 0, 5], [-5, -1, 2, 7]],
    lead: [12, 16, 19, 16, 19, 24, 19, 16],
    swing: 0.15,
  },

  // --- 📜 Classic Ghazal Collection ---
  {
    id: 'aaj-jane-ki-zid',
    title: 'Aaj Jane Ki Zid Na Karo',
    artist: 'Farida Khanum & Fayyaz Hashmi',
    category: 'GHAZAL',
    audioUrl: '/audio/aaj_jane_ki_zid.mp3',
    bpm: 62,
    root: 41,
    progression: [[0, 3, 7, 10], [5, 8, 12, 15], [-2, 1, 5, 8], [3, 7, 10, 14]],
    lead: [12, 15, 17, 15, 12, 10, 8, 12],
    swing: 0.18,
  },
  {
    id: 'hoshwalon-ko-khabar',
    title: 'Hoshwalon Ko Khabar Kya',
    artist: 'Jagjit Singh (Ghazal)',
    category: 'GHAZAL',
    audioUrl: '/audio/hoshwalon.mp3',
    bpm: 66,
    root: 43,
    progression: [[0, 4, 7, 11], [-5, 0, 3, 7], [-3, 2, 5, 9], [-7, -3, 0, 5]],
    lead: [16, 19, 23, 19, 16, 14, 12, 14],
    swing: 0.14,
  },
  {
    id: 'chupke-chupke-raat-din',
    title: 'Chupke Chupke Raat Din',
    artist: 'Ghulam Ali (Ghazal)',
    category: 'GHAZAL',
    audioUrl: '/audio/chupke_chupke.mp3',
    bpm: 60,
    root: 41,
    progression: [[0, 3, 7, 10], [-4, 0, 3, 7], [-2, 1, 5, 8], [3, 7, 10, 14]],
    lead: [12, 15, 18, 15, 12, 10, 8, 12],
    swing: 0.16,
  },
  {
    id: 'jhuki-jhuki-si-nazar',
    title: 'Jhuki Jhuki Si Nazar',
    artist: 'Jagjit Singh (Ghazal)',
    category: 'GHAZAL',
    audioUrl: '/audio/jhuki_jhuki.mp3',
    bpm: 64,
    root: 45,
    progression: [[0, 4, 7, 11], [-3, 1, 5, 9], [-5, -1, 2, 7], [-7, -3, 0, 5]],
    lead: [16, 19, 21, 19, 16, 14, 12, 16],
    swing: 0.15,
  },
]
