  ...
  return (
    <div className="h-full w-full bg-white text-black p-8 font-serif flex flex-col justify-between items-center text-center select-text overflow-y-auto">
      <div className="my-auto space-y-6">
        ...
        {/* Positioning Summary */}
        <p className="max-w-md mx-auto text-sm opacity-40 font-sans leading-relaxed">
          {profile.positioning}
        </p>
      ...
      {/* Footer Tagline */}
      <div className="text-[11px] opacity-60 font-sans pt-4 border-t border-zinc-200 w-full">
